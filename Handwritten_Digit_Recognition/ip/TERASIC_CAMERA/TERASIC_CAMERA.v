// Packet: follow video packet of "Intel FPGA Streaming Video Protocol" defined VIP spec.
...
output  [23:0]  tdata;
output          tvalid;
output  [ 2:0]  tuser;      // start of packet
...
assign line_end = (RGB_X + 1 == VIDEO_W);
...
begin
	...
	begin
		if (!fifo_w_full)
		begin
			fifo_w_data <= {sop, line_end, RGB_B[11:4], RGB_G[11:4], RGB_R[11:4]};
			fifo_w_write <= 1'b1;
		end
		else
		begin
...
// read from fifo
wire 		fifo_r_empty;
wire [25:0] fifo_r_q/*synthesis keep*/;
...
//----------------------------
// AXI Stream          
assign tuser  = send_packet_id ? 1'b1 : 1'b0;
assign tlast = fifo_r_q[24];
assign tdata  = fifo_r_q[23:0];
assign tvalid = ~fifo_r_empty;
assign fifo_r_rdreq_ack = tvalid & tready;
